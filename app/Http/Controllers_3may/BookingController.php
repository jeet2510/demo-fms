...
class BookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $booking->transporter_id = $validatedData['transporter_id'];
...
// dd('ok');
    ...
    public function edit($id)
    {
        ...
        return view('bookings.edit', compact('booking', 'customers','transporters', 'routes', 'clients', 'drivers', 'borders'));
    }
    ...
    public function show($id)
    {
        ...
        $drivers = Driver::where('created_by', Auth::user()->creatorId())->get();
        $borders = Border::where('created_by', Auth::user()->creatorId())->get();
        return view('bookings.show',  compact('booking', 'customers','transporters', 'routes', 'clients', 'drivers', 'borders'));
    }
