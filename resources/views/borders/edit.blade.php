    ...
    <div class="container">
        ...
        <form action="{{ route('borders.update', $border->id) }}" method="post">
            ...
            <div class="form-group">
                ...
                <select name="country_id" id="country_id" class="form-input" required>
                    ...
                    @foreach ($countries as $country)
                        <option value="{{ $country->id }}" {{ $border->country_id == $country->id ? 'selected' : '' }}>
                            {{ $country->name }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="border_name" name="border_name" class="form-input"
                    value="{{ $border->border_name }}" required>
            </div>
            {{-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="border_charges" name="border_charges" class="form-input"
                    value="{{ $border->border_charges }}" required>
            </div><br>
            {{-- <div class="form-group">
