<script>
    document.addEventListener('DOMContentLoaded', function() {
        const existingSvg = document.querySelector('svg[style="max-height: 40px;"]');
        const newSvgMarkup =
            `<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M256-181.912 181.912-256l224-224-224-224L256-778.088l224 224 224-224L778.088-704l-224 224 224 224L704-181.912l-224-224-224 224Z"/></svg>`;
        const tempElement = document.createElement('div');
        tempElement.innerHTML = newSvgMarkup;
        const newSvg = tempElement.querySelector('svg');
        if (existingSvg) {
...
<header class="z-40" :class="{ 'dark': $store.app.semidark && $store.app.menu === 'horizontal' }">
    <div class="shadow-sm">
        <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
            ...
            <div style="margin-left: 95%;" x-data="header"
