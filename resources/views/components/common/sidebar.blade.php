        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    ...
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">FMS</span>
                </a>
                <a href="javascript:;"
                ...
                <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                    ...
                    <li class="menu nav-item">
                        <button type="button" class="nav-link group"
                            ...
                            <div class="flex items-center">
                                ...
                                <span
                                    class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Transporter</span>
                            </div>
                            <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'transporter' }">
                    ...
                    <li class="menu nav-item">
                        ...
                        <ul x-cloak x-show="activeDropdown === 'report'" x-collapse class="sub-menu text-gray-500">
                            ...
                            <li>
                                <a href="{{ route('reports.driverIndex') }}">Driver Report</a>
                            </li>
                            <li>
                                <a href="{{ route('reports.transporterIndex') }}">Transporter Report</a>
                            </li>
                            <li>
                                <a href="{{ route('reports.invoiceIndex') }}">Invoice Report</a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">User
                                        Management</span>
                                </div>
