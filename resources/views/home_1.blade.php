                        ...
                        <td class="p-2">
                            @if (!$booking->invoice)
                                <a href="{{ route('bookings.edit', $booking->id) }}" class="btn btn-primary"
                                    style="width: 50px; display: inline-block;"><svg width="24" height="24"
                            ...
                            @else
                                <a href="{{ route('bookings.edit', $booking->id) }}" class="btn btn-primary"
                                    ...
                                    disabled><svg width="24" height="24" viewBox="0 0 24 24"
                            ...
                            @if (!$booking->invoice)
                                <form action="{{ route('bookings.destroy', $booking->id) }}" method="post"
                                    ...
                                    <button type="submit" class="btn btn-danger" style="width: 50px;">
                                        <div
                                            class="grid place-content-center w-14 h-6 border border-white-dark/20 dark:border-[#191e3a] rounded-md pt-5">
                            ...
                            @else
                                <form action="{{ route('bookings.destroy', $booking->id) }}" method="post"
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger" style="width: 50px;" disabled>
                                        <div
                            ...
                            <a href="{{ route('bookings.show', $booking->id) }}" class="btn btn-primary"
                                style="width: 50px; display: inline-block; margin-top:5px;"><svg width="24"
                                ...
                                <div x-data="modal">
                                    @if ($booking->booking_document)
                                        ...
                                        <a href="{{ asset($booking->booking_document) }}" class="btn btn-info"
                                            ...
                                            style="margin-bottom:20px; width: 70px">
                                    ...
                                    @else
                                        <button type="button" class="btn btn-primary" @click="toggle"
                                            style="width: 80px; float:right; margin-bottom: 18px;"><svg
