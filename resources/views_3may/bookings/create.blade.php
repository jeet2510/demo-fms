...
<div class="grid grid-cols-2 gap-4">
            ...
            <div class="mb-4">
                ...
                <select name="transporter_id" id="transporter_id" class="form-select select2 mt-1 block w-full" placeholder="Select Transporter" required>
			 ...
			 <div class="mb-4">
                ...
                <select name="driver_id[]" id="driver_id" class="form-select mt-1 block w-full" placeholder="Select Driver"multiple="multiple" required>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        document.getElementById('bookingForm').addEventListener('submit', function(event) {
            ...
            if (!bookingId || !date || !customerId || !receiverId || !transporterId || !driverIds || !routeId || !buyingAmount || !borderCharges || !totalBookingAmount) {
                alert('Please fill in all fields.');
                return;
            }

            // Validate buying amount, border charges, and total booking amount to be numeric
            if (isNaN(parseFloat(buyingAmount)) || isNaN(parseFloat(borderCharges)) || isNaN(parseFloat(totalBookingAmount))) {
