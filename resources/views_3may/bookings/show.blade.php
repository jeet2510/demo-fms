...
?>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="mb-4">
                    ...
                    <span id="customer_value" class="block border border-gray-300 p-2 rounded">{{ $booking->customer->company_name ?? 'No Customer Selected' }}</span>
                </div>


                <div class="mb-4">
                    <label for="transporter_id" class="block text-gray-700">Transporter</label>
                    <span id="transporter_value" class="block border border-gray-300 p-2 rounded">{{ $booking->transporter->transporter_name ?? 'No Transporter Selected' }}</span>
                </div>
            ...
            <select name="driver_id[]" id="driver_id" class="form-select mt-1 block w-full" multiple disabled>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="mb-4">
                    ...
                    <span id="buying_amount_value" class="block border border-gray-300 p-2 rounded">{{ $booking->buying_amount }}</span>
                </div>


                <div class="mb-4">
                    <label for="border_charges" class="block text-gray-700">Border Charges</label>
                    <span id="border_charges_value" class="block border border-gray-300 p-2 rounded">{{ $booking->border_charges }}</span>
                </div>


                <div class="mb-4">
                    <label for="total_booking_amount" class="block text-gray-700">Total Booking Amount</label>
                    <span id="total_booking_amount_value" class="block border border-gray-300 p-2 rounded">{{ $booking->total_booking_amount }}</span>
                </div>
    ...
    if (selectedRoute) {
        const routeDetails = JSON.parse(document.querySelector('#route_id [value="' + selectedRoute + '"]').getAttribute('data-route-detail'));
