                ...
                <div class="grid grid-cols-2 gap-4" style="margin-top: 5px;">
                    <div>
                        ...
                        <input type="text" name="address" id="address" class="form-input"
                               value="{{ $customer->address }}" required placeholder="Enter address" required>
                    </div>
                    <div>
                        <label for="city">City</label>
                        <input type="text" name="city" id="city" class="form-input"
                               value="{{ $customer->city }}" required placeholder="Enter city">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4" style="margin-top: 8px;">
                    <div>
                        ...
                        <input type="text" name="state" id="state" class="form-input"
                               value="{{ $customer->state }}" required placeholder="Enter state">
                    </div>
                    <div>
                        <label for="pin_code">Pin Code</label>
                        <input type="text" name="pin_code" id="pin_code" class="form-input"
                               value="{{ $customer->pin_code }}" required placeholder="Enter pin code">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4" style="margin-top: 8px;">
                    <div>
                        ...
                        <input type="text" name="country" id="country" class="form-input"
                               value="{{ $customer->country }}" required placeholder="Enter country">
                    </div>
                    <div>
