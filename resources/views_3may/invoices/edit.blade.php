        ...
        <form action="{{ route('invoices.invoiceStore') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="mb-4">
                        ...
                        <input type="hidden" id="route_id" name="route_id" class="form-input mt-1 block w-full" value="{{ $booking->route_id }}" readonly>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="mb-4">
                    ...
                    <input type="hidden" id="customer_id" name="customer_id" class="form-input mt-1 block w-full" value="{{ $booking->customer_id }}" readonly>
                    <input type="text"  class="form-input mt-1 block w-full" value="{{ $booking->customer->company_name }}" readonly>
                </div>

                <div class="mb-4">
                    <label for="receiver_id" class="block text-gray-700">Receiver</label>
                    <input type="hidden" id="receiver_id" name="receiver_id" class="form-input mt-1 block w-full" value="{{ $booking->receiver_id }}" readonly>
                    <input type="text" class="form-input mt-1 block w-full" value="{{ $booking->client->company_name }}" readonly>
                </div>

				<div class="mb-4">
                    <label for="receiver_id" class="block text-gray-700">Transporter</label>
                    <input type="hidden" id="transporter_id" name="receiver_id" class="form-input mt-1 block w-full" value="{{ $booking->receiver_id }}" readonly>
                    <input type="text" class="form-input mt-1 block w-full" value="{{ optional($booking->transporter)->transporter_name }}" readonly>
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="mb-4">
                    ...
                    <input type="text" name="buying_amount" id="buying_amount"
                        class="form-input mt-1 block w-full" value="{{ $booking->buying_amount }}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="waiting_amount" id="waiting_amount"
                        class="form-input mt-1 block w-full" value="0">
                </div>
                                ...
                                if (data.success) {
                                    ...
                                    var row = $('<tr>' +
                                        ...
                                        driverData.passport_expiry_date + (
                                            ...
                                            ' <button class="password_upload-button" data-id ='+ driverId +'>Upload</button>' :
                                            '') + '</td>' +
                                        '<td class="border p-4' + (isDateExpired(
                                        ...
                                        driverData.id_card_expiry_date + (
                                            isDateExpired(driverData
                                                .id_card_expiry_date) ?
                                            ' <button class="idcard_upload-button" data-id ='+ driverId +' >Upload</button>' :
                                            '') + '</td>' +
                                        '<td class="border p-4">' + driverData
                                        ...
                                        driverData.driving_license_expiry_date + (
                                            isDateExpired(driverData
                                                .driving_license_expiry_date) ?
                                            ' <button class="driver_upload-button" data-id ='+ driverId +'>Upload</button>' :
                                            '') + '</td>' +
