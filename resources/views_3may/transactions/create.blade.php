<form action="{{ route('transactions.store') }}" method="post">
    ...
    <div class="grid mt-4 grid-cols-1 sm:grid-cols-2 gap-4">
        <div class="mr-5">
            ...
            <input id="transactionid" name="transaction_id" type="text" placeholder="Enter Transaction Id"
                class="form-input" required="" value="TRANSACTION-1712997448370-10">
        </div>
        <div class="mr-5">
    ...
    <div class="mt-4">
        <div>
            ...
            <input id="payable_ammount" type="number" name="cheque_number" placeholder="Enter Cheque Number / ref No"
                class="form-input" required="" value="">
