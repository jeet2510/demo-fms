        ...
        <form action="{{ route('bookings.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <select name="transporter_id" id="transporter_id" class="form-select select2 mt-1 block w-full"
                        placeholder="Select Transporter" required>
                ...
                <div class="mb-4">
                    ...
                    <select name="driver_id[]" id="driver_id" class="form-select mt-1 block w-full"
                        placeholder="Select Driver"multiple="multiple" required>
