                        ...
                        <td class="p-2">
                            ...
                            @if (!$booking->invoice)
                                <a href="{{ route('bookings.edit', $booking->id) }}" class="btn btn-primary"
                                    style="width: 50px; display: inline-block; margin-right: 10px;"><svg width="24" height="24"
                            ...
                            @else
                                <a href="{{ route('bookings.edit', $booking->id) }}" class="btn btn-primary"
                                    style="width: 50px; display: inline-block; margin-right: 10px;" onclick="return false;"
                            ...
                            <a href="{{ route('bookings.show', $booking->id) }}" class="btn btn-primary"
                                style="width: 50px; display: inline-block; margin-right: 10px;"><svg width="24"
